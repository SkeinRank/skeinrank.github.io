...
assert.match(landing, /data-copy-target="sr-sdk-install-code"/, 'landing should include a copy action for the install command');
assert.match(landing, /data-copy-target="sr-sdk-snippet"/, 'landing should include a copy action for the Python SDK snippet');
assert.match(landing, /sdk quickstart/, 'landing should label the terminal card as an SDK quickstart');
...
assert.ok(!landing.includes('sr-sdk-output-grid'), 'SDK example cards should use the polished integrated footer layout');
